...
Elm.Steps.make = function (_elm) {
   ...
   var Time = Elm.Time.make(_elm);
   var _op = {};
   var zoomStep = F2(function (keyboardInput,
   gameState) {
      return function () {
         var zoomedScale = gameState.scale + 2.0e-2 * gameState.scale * Basics.toFloat(keyboardInput.zoom);
         var minScale = 0.5;
         var maxScale = 3.0;
         var newScale = _U.cmp(zoomedScale,
         minScale) < 0 ? minScale : _U.cmp(zoomedScale,
         maxScale) > 0 ? maxScale : zoomedScale;
   ...
   player) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var scaledDims = {ctor: "_Tuple2"
                                  ,_0: Basics.toFloat(_v22._0) / gameState.scale
                                  ,_1: Basics.toFloat(_v22._1) / gameState.scale};
                 var $ = player,
                 position = $.position,
                 direction = $.direction,
                 velocity = $.velocity,
      ...
      return function () {
         ...
         {case "_Tuple4":
            switch (_v26._0.ctor)
              {case "Just":
                 return function () {
                      var _v32 = player.controlMode;
                      switch (_v32.ctor)
                      {case "FixedDirection":
                         return function () {
                              var maxTurn = List.minimum(_L.fromArray([2
                                                                      ,Basics.abs(player.direction - _v26._0._0)]));
                              return _U.cmp(Core.ensure360(player.direction - _v26._0._0),
                              180) > 0 ? maxTurn : 0 - maxTurn;
                           }();
                         case "FixedWindAngle":
                         return function () {
                              var maxTurn = List.minimum(_L.fromArray([2
                                                                      ,Basics.abs(player.windAngle - _v26._0._0)]));
                              return _U.cmp(_v26._0._0,
                              90) > 0 || _U.cmp(_v26._0._0,
                              0) < 0 && _U.cmp(_v26._0._0,
                   ...
                   {case "FixedDirection":
                      ...
                      switch (_v26._2)
                        {case 0: switch (_v26._3)
                             ...
                             break;}
                        break;}
                   return fineTurn ? _v26._2 : _v26._2 * 3;}
              break;}
         _E.Case($moduleName,
         ...
         {case "_Tuple2":
            switch (_v33._0.ctor)
              {case "Just":
                 switch (_v33._1.ctor)
                   {case "FixedDirection":
                      return _U.cmp(Basics.abs(_v33._0._0 - player.direction),
                        0.1) < 0;
                      case "FixedWindAngle":
                      return _U.cmp(Basics.abs(_v33._0._0 - player.windAngle),
                        0.1) < 0;}
                   break;
         ...
         {case "_Tuple2":
            switch (_v37._0.ctor)
              {case "Just":
                 ...
                 case "Nothing": switch (_v37._1)
                   {case false:
                      return Maybe.Nothing;
                      case true: return function () {
                           var _v41 = player.controlMode;
                           switch (_v41.ctor)
                           {case "FixedDirection":
   ...
   var keysForPlayerStep = F3(function (_v42,
   spells,
   player) {
      return function () {
         return function () {
            var forceTurn = !_U.eq(_v42.arrows.x,
            0);
            ...
            var controlMode = forceTurn ? Game.FixedDirection : _U.cmp(_v42.arrows.y,
            0) > 0 || _v42.lockAngle ? Game.FixedWindAngle : turnedPlayer.controlMode;
            return _U.replace([["controlMode"
                               ,controlMode]
                              ,["tackTarget"
                               ,tackTargetAfterTurn]
                              ,["spellCast",_v42.spellCast]
                              ,["startCountdown"
                               ,_v42.startCountdown]],
            turnedPlayer);
         }();
   ...
   var mouseStep = F2(function (_v44,
   gameState) {
      return function () {
         return function () {
   ...
   gameState) {
      ...
      input.raceInput.now,
      input.delta,
      input.windowInput)(zoomStep(input.keyboardInput)(keysStep(input.keyboardInput)(windStep(input.raceInput.wind)(A2(raceInputStep,
      input.raceInput,
      gameState))))));
   });
...
Elm.Render.Race.make = function (_elm) {
   ...
   var Time = Elm.Time.make(_elm);
   var _op = {};
   var renderFinished = F3(function (course,
   player,
   sc) {
      return function () {
         ...
         {case "Nothing":
            return Maybe.Just(Graphics.Collage.move({ctor: "_Tuple2"
                                                    ,_0: 0
                                                    ,_1: course.downwind.y * sc + 40})(Graphics.Collage.toForm(Text.centered(Render.Utils.baseText("Finished!")))));}
         return Maybe.Nothing;
      }();
   });
   ...
   var renderCountdown = function (gameState) {
      return function () {
         var messageBuilder = function (msg) {
            return Graphics.Collage.move({ctor: "_Tuple2"
                                         ,_0: 0
                                         ,_1: gameState.course.downwind.y * gameState.scale + 40})(Graphics.Collage.toForm(Text.centered(Render.Utils.baseText(msg))));
         };
         return function () {
            ...
            {case "Just":
               return _U.cmp(_v1._0,
                 0) > 0 ? Maybe.Just(messageBuilder(formatCountdown(Core.getCountdown(gameState.countdown)))) : _U.eq(gameState.player.nextGate,
   ...
   sc) {
      return function () {
         ...
         Basics.fromPolar({ctor: "_Tuple2"
                          ,_0: 1000
                          ,_1: windAngleRad - vmgRad - Basics.pi / 2}));
         return Graphics.Collage.scale(sc)(Graphics.Collage.alpha(0.3)(Graphics.Collage.group(A2(List.map,
         drawLine,
   ...
   var renderLaylines = F3(function (player,
   course,
   sc) {
      return function () {
         ...
         {case "Just":
            switch (_v7._0.ctor)
              {case "Downwind":
                 return Maybe.Just(A4(renderGateLaylines,
                   player.downwindVmg,
                   player.windOrigin,
                   course.downwind,
                   sc));
   ...
   var renderBuoy = F3(function (timer,
   sc,
   _v9) {
      return function () {
         return function () {
            var a = 0.4 + 0.2 * Basics.cos(timer * 5.0e-3);
            return Graphics.Collage.scale(sc)(Graphics.Collage.alpha(a)(Graphics.Collage.move(A2(Geo.scalePoint,
            sc,
            _v9.position))(Graphics.Collage.filled(Render.Utils.colors.buoy)(Graphics.Collage.circle(_v9.radius)))));
         }();
      }();
   });
   ...
   var renderIslands = F2(function (course,
   sc) {
      return Graphics.Collage.scale(sc)(Graphics.Collage.group(A2(List.map,
      renderIsland,
      course.islands)));
   });
   var renderGust = F3(function (wind,
   sc,
   gust) {
      return function () {
         ...
         return Graphics.Collage.move(A2(Geo.scalePoint,
         sc,
         gust.position))(Graphics.Collage.alpha(a)(Graphics.Collage.filled(color)(Graphics.Collage.circle(gust.radius * sc))));
      }();
   });
   var renderGusts = F2(function (wind,
   sc) {
      return Graphics.Collage.group(A2(List.map,
      A2(renderGust,wind,sc),
      wind.gusts));
   });
   var renderBounds = F2(function (box,
   sc) {
      return function () {
         var $ = box,
         ne = $._0,
         ...
         return Graphics.Collage.scale(sc)(Graphics.Collage.move(A2(Geo.scalePoint,
         sc,
         {ctor: "_Tuple2"
         ,_0: cw
         ,_1: ch}))(Graphics.Collage.alpha(0.3)(Graphics.Collage.outlined(Graphics.Collage.dashed(Color.black))(A2(Graphics.Collage.rect,
         w,
         h)))));
      }();
   });
   var renderOpponent = F2(function (sc,
   opponent) {
      return function () {
         var p = A2(Geo.scalePoint,
         sc,
         opponent.position);
         var hull = Graphics.Collage.alpha(0.5)(Graphics.Collage.move(p)(Graphics.Collage.rotate(Core.toRadians(opponent.direction + 90))(Graphics.Collage.toForm(A3(Graphics.Element.image,
         11,
         20,
   ...
   spells) {
      return function () {
         ...
         190,
         250)));
         return A2(Game.containsSpell,
         "Fog",
         spells) ? List.map(Graphics.Collage.scale(sc))(_L.fromArray([fog1
                                                                     ,fog2])) : _L.fromArray([]);
      }();
   });
   var renderBoat = F2(function (filename,
   sc) {
      return function () {
         var realLength = 13.45;
         var scaledLength = realLength * sc;
         var picWidth = 11;
         var picHeight = 20;
         var w = realLength * picWidth / picHeight;
         var scaledWidth = scaledLength * picWidth / picHeight;
         return Graphics.Collage.toForm(A3(Graphics.Element.image,
         Basics.round(scaledWidth),
         Basics.round(scaledLength),
         _L.append("/assets/images/",
         _L.append(filename,".png"))));
      }();
   });
   var renderWake = F2(function (wake,
   sc) {
      return function () {
         ...
         var scaledPoints = A2(List.map,
         Geo.scalePoint(sc),
         wake);
         var pairs = List.isEmpty(scaledPoints) ? _L.fromArray([]) : Core.indexedMap(F2(function (v0,
         v1) {
            return {ctor: "_Tuple2"
                   ,_0: v0
                   ,_1: v1};
         ...
         scaledPoints,
         List.tail(scaledPoints)));
         var opacityForIndex = function (i) {
            return 0.3 - 0.3 * Basics.toFloat(i) / Basics.toFloat(List.length(scaledPoints));
         };
   ...
   var renderEqualityLine = F3(function (_v19,
   windOrigin,
   sc) {
      return function () {
         switch (_v19.ctor)
   ...
   var renderPlayerAngles = F2(function (sc,
   player) {
      return function () {
         var windOriginRadians = Core.toRadians(player.direction - player.windAngle);
         var windMarker = Graphics.Collage.alpha(0.5)(Graphics.Collage.move(A2(Geo.scalePoint,
         sc,
         Basics.fromPolar({ctor: "_Tuple2"
                          ,_0: 20
                          ,_1: windOriginRadians})))(Graphics.Collage.scale(sc)(Graphics.Collage.rotate(windOriginRadians + Basics.pi / 2)(Graphics.Collage.filled(Color.white)(Graphics.Collage.polygon(_L.fromArray([{ctor: "_Tuple2"
                                                                                                                                                                                                                       ,_0: 0
                                                                                                                                                                                                                       ,_1: 4}
                                                                                                                                                                                                                      ,{ctor: "_Tuple2"
                                                                                                                                                                                                                       ,_0: -3
                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                      ,{ctor: "_Tuple2"
                                                                                                                                                                                                                       ,_0: 3
                                                                                                                                                                                                                       ,_1: -4}])))))));
         var windAngleText = Graphics.Collage.alpha(0.5)(Graphics.Collage.move(A2(Geo.scalePoint,
         sc,
         Basics.fromPolar({ctor: "_Tuple2"
                          ,_0: 20
                          ,_1: windOriginRadians + Basics.pi})))(Graphics.Collage.toForm(Text.centered((_U.eq(player.controlMode,
         Game.FixedWindAngle) ? Text.line(Text.Under) : Basics.id)(Render.Utils.scaledText(sc * 0.8)(_L.append(String.show(Basics.abs(Basics.round(player.windAngle))),
         "&deg;")))))));
   ...
   sc) {
      return function () {
         var wake = A2(renderWake,
         player.wake,
         sc);
         var fog = A3(renderFog,
         sc,
         player,
         spells);
         var helpers = _U.cmp(sc,
         1) > 0 ? _L.fromArray([A2(renderPlayerAngles,
                               sc,
                               player)
                               ,A3(renderEqualityLine,
                               player.position,
                               player.windOrigin,
                               sc)]) : _L.fromArray([]);
         ...
         var hull = Graphics.Collage.rotate(Core.toRadians(player.direction + 90))(A2(renderBoat,
         boatPath,
         sc));
         var movingPart = Graphics.Collage.move(A2(Geo.scalePoint,
         sc,
         player.position))(Graphics.Collage.group(_L.append(helpers,
         _L.append(_L.fromArray([hull]),
         fog))));
   ...
   sc) {
      return function () {
         ...
         return Graphics.Collage.scale(sc)(Graphics.Collage.group(_L.fromArray([line
                                                                               ,leftMark
                                                                               ,rightMark])));
      }();
   });
   var renderStartLine = F5(function (gate,
   markRadius,
   started,
   timer,
   sc) {
      return function () {
         ...
         left,
         right)));
         return Graphics.Collage.scale(sc)(Graphics.Collage.group({ctor: "::"
                                                                  ,_0: line
                                                                  ,_1: marks}));
      }();
   });
   var renderRace = function (_v23) {
      return function () {
         return function () {
            var sc = _v23.scale;
            var downwindOrStartLine = List.isEmpty(_v23.player.crossedGates) ? A5(renderStartLine,
            ...
            sc);
            var justForms = _L.fromArray([A2(renderBounds,
                                         _v23.course.bounds,
                                         sc)
                                         ,A2(renderIslands,
                                         _v23.course,
                                         ...
                                         renderOpponent(sc),
                                         _v23.opponents))
                                         ,A2(renderGusts,_v23.wind,sc)
                                         ,A3(renderPlayer,
                                         _v23.player,
                                         _v23.triggeredSpells,
                                         sc)]);
            var maybeForms = _L.fromArray([renderCountdown(_v23)
                                          ,A2(Core.mapMaybe,
                                          function (c) {
                                             return Graphics.Collage.group(A2(List.map,
                                             A2(renderBuoy,c,sc),
                                          ...
                                          _v23.player,
                                          sc)]);
            return Graphics.Collage.move(Geo.neg(A2(Geo.scalePoint,
            sc,
            _v23.player.center)))(Graphics.Collage.group(_L.append(justForms,
...
Elm.Render.Controls.make = function (_elm) {
   ...
   var renderPoleInversion = function () {
      var arrow = Graphics.Collage.scale(3)(Graphics.Collage.filled(Color.white)(Graphics.Collage.polygon(getArrow)));
   ...
   var renderScale = F2(function (sc,
   _v13) {
      return function () {
         switch (_v13.ctor)
         {case "_Tuple2":
            return function () {
                 var lineWidth = 100.0;
                 var s = Graphics.Collage.traced(Graphics.Collage.solid(Color.white))(A2(Graphics.Collage.segment,
                 {ctor: "_Tuple2"
                 ,_0: 0 - lineWidth
                 ,_1: 0},
                 {ctor: "_Tuple2",_0: 0,_1: 0}));
                 var carets = A2(List.map,
                 function (y) {
                    return Graphics.Collage.traced(Graphics.Collage.solid(Color.white))(A2(Graphics.Collage.segment,
                    {ctor: "_Tuple2",_0: y,_1: 0},
                    {ctor: "_Tuple2",_0: y,_1: 5}));
                 },
                 _L.fromArray([0 - lineWidth
                              ,0]));
                 var t = Graphics.Collage.move({ctor: "_Tuple2"
                                               ,_0: (0 - lineWidth) / 2
                                               ,_1: 15})(Graphics.Collage.toForm(Text.centered(Render.Utils.baseText(_L.append(String.show(Basics.round(lineWidth / sc)),
                 "m")))));
                 return Graphics.Collage.move({ctor: "_Tuple2"
                                              ,_0: _v13._0 / 2 - 20
                                              ,_1: (0 - _v13._1) / 2 + 20})(Graphics.Collage.group(_L.append(_L.fromArray([s
                                                                                                                          ,t]),
                 carets)));
              }();}
         _E.Case($moduleName,
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 var windSpeedText = Graphics.Collage.toForm(Text.centered(Render.Utils.baseText(_L.append(String.show(Basics.round(Core.mpsToKn(wind.speed))),
                 "kn"))));
                 ...
                 return Graphics.Collage.alpha(0.8)(Graphics.Collage.move({ctor: "_Tuple2"
                                                                          ,_0: _v17._0 / 2 - 50
                                                                          ,_1: _v17._1 / 2 - 120})(Graphics.Collage.group(_L.fromArray([c
                                                                                                                                       ,windMarker
                                                                                                                                       ,windOriginText
                                                                                                                                       ,windSpeedText
                                                                                                                                       ,legend]))));
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 _L.append("&deg;\n",
                 _L.append(String.show(Basics.round(Core.mpsToKn(player.velocity))),
                 "kn"))))))));
                 return Graphics.Collage.move({ctor: "_Tuple2"
                                              ,_0: (0 - _v21._0) / 2 + 20
                                              ,_1: _v21._1 / 2 - maxSpeed / 2 - 20})(Graphics.Collage.group(_L.fromArray([yAxis
                                                                                                                         ,xAxis
                                                                                                                         ,polar
                                                                                                                         ,playerProjection
                                                                                                                         ,playerMark
         ...
         _E.Case($moduleName,
         "between lines 48 and 66");
      }();
   });
   var renderLapsCount = F3(function (_v25,
   course,
   player) {
      return function () {
         switch (_v25.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 return Graphics.Collage.move({ctor: "_Tuple2"
                                              ,_0: _v25._0 / 2 - 50
                                              ,_1: _v25._1 / 2 - 30})(Graphics.Collage.toForm(Text.rightAligned(Render.Utils.baseText(msg))));
              }();}
         _E.Case($moduleName,
                 ...
                 {case "_Tuple2":
                    return function () {
                         var distance = function (isOver) {
                            return Basics.round(Basics.abs(gate.y + (isOver ? 0 - _v29._1 : _v29._1) / 2 - _v30._1) / 2);
                         };
                         var a = 1 + 0.5 * Basics.cos(timer * 5.0e-3);
                         var markStyle = Graphics.Collage.filled(Color.orange);
                         var c = 5;
                         var isOver = _U.cmp(_v30._1 + _v29._1 / 2 + c,
                         gate.y) < 0;
                         var isUnder = _U.cmp(_v30._1 - _v29._1 / 2 - c,
                         gate.y) > 0;
                         var side = isOver ? _v29._1 / 2 : isUnder ? (0 - _v29._1) / 2 : 0;
                         var $ = Game.getGateMarks(gate),
                         left = $._0,
                         right = $._1;
   ...
   var renderControls = F2(function (_v37,
   dims) {
      return function () {
         return function () {
            var upwindHint = _U.eq(_v37.player.nextGate,
            Maybe.Just(Game.Upwind)) ? A4(renderGateHint,
            _v37.course.upwind,
            dims,
            _v37.player.center,
            _v37.now) : Maybe.Nothing;
            var downwindHint = _U.eq(_v37.player.nextGate,
            Maybe.Just(Game.Downwind)) ? A4(renderGateHint,
            _v37.course.downwind,
            dims,
            _v37.player.center,
            _v37.now) : Maybe.Nothing;
...
Elm.Inputs.make = function (_elm) {
   ...
   0,
   Time.fps(1));
   var zoomInput = A3(Signal.lift2,
   F2(function (plus,minus) {
      return plus ? 1 : minus ? -1 : 0;
   }),
   Keyboard.isDown(Char.toCode(_U.chr("Z"))),
   Keyboard.isDown(Char.toCode(_U.chr("U"))));
   ...
   Mouse.position);
   var KeyboardInput = F7(function (a,
   b,
   c,
   d,
   e,
   ...
   var keyboardInput = A8(Signal.lift7,
   KeyboardInput,
   Keyboard.arrows,
   Keyboard.enter,
   Keyboard.space,
...
Elm.Core.make = function (_elm) {
   ...
   var knFactor = 1.94384449;
   var mpsToKn = function (v) {
      return v * knFactor;
   };
   var knToMps = function (v) {
      return v / knFactor;
   };
   var polarVelocity = F2(function (windSpeed,
   windAngle) {
      return function () {
         var x2 = windAngle;
         var x1 = mpsToKn(windSpeed);
...
Elm.Render.Utils.make = function (_elm) {
   ...
   var scaledText = F2(function (sc,
   s) {
      return Text.typeface(_L.fromArray(["Inconsolata"
                                        ,"monospace"]))(Text.color(Color.white)(Text.height(15.0 * sc)(Text.toText(s))));
   });
   var baseText = scaledText(1);
